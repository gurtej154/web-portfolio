...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_3n73atb', 'template_ee6pvc6', form.current, 's8TViZ2ibjjsOAL30')
      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <h4>Email</h4>
            <h5>gurtej154@gmail.com</h5>
            <a href="mailto:gurtej154@gmail.com" target="_blank">Send a message</a>
          </article>
          <article className="contact__option">
            <SiDiscord className='contact__option-icon'/>
            <h4>Discord</h4>
            <h5>gurtej736#4199</h5>
            <a href="https://discord.com/channels/@me" target="_blank">Send a message</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp className='contact__option-icon'/>
            <h4>WhatsApp</h4>
            <h5>+61 400 157 144</h5>
